...
<img src="https://capsule-render.vercel.app/api?type=venom&height=200&text=Muhammed%20Shafi%20EK&fontSize=52&color=0:0f0c29,50:302b63,100:24243e&fontColor=00f5d4&stroke=00f5d4&strokeWidth=1.5&animation=fadeIn&desc=Full%20Stack%20Developer%20%E2%80%94%20.NET%20%2B%20React&descSize=18&descAlignY=75&descFontColor=a78bfa"/>

</div>

<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=00F5D4&center=true&vCenter=true&width=600&lines=Building+scalable+systems+🔧;Clean+Architecture+%2B+CQRS+enthusiast;Real-time+apps+with+SignalR+%2B+Redis;React+%2B+.NET+8+Full+Stack;Deployed+on+AWS+%26+Azure+☁️)](https://git.io/typing-svg)
...
const shafi = {
  ...
  stack    : [".NET 8", "React.js", "TypeScript"],
  arch     : ["Clean Architecture", "CQRS", "MediatR"],
...
![.NET](https://img.shields.io/badge/.NET%208-%23512BD4?style=for-the-badge&logo=dotnet&logoColor=white)
![ASP.NET](https://img.shields.io/badge/ASP.NET%20Core-%23512BD4?style=for-the-badge&logo=dotnet&logoColor=white)
...
### 🏆 SPL — Sports League System
`LIVE`

> Full-stack tournament management platform

- ⚙️ `.NET 8` + `Clean Architecture` + `CQRS`
- ⚡ `Redis` caching + `Dapper` read optimization
...
### 🛒 FITiN — E-Commerce Platform
`GitHub`

> End-to-end shopping platform

- 🔌 RESTful APIs — product, cart, orders
- ☁️ Deployed on `AWS EC2` + `S3`
- 🗄️ `Azure SQL` + `Entity Framework Core`
...
```
Form Submit ──▶ Google Sheets ──▶ CRM ──▶ Gmail Welcome ──▶ Slack Alert
Cron Trigger ──▶ Notion Tasks ──▶ Personalised Slack/WhatsApp Digest
Gmail Inbox ──▶ Log Applicants ──▶ Keyword Flag ──▶ Slack Review Alert
```

> Integrations: `Gmail` · `Google Sheets` · `Slack` · `Notion` · `HubSpot` · `WhatsApp (Twilio)` · `REST APIs`
